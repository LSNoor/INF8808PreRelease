...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/d3.v3.min.js":[function(require,module,exports) {
...
d4 = function () {
  ...
  function f() {
    for (var n, t = ua.event; n = t.sourceEvent;) {
      t = n;
    }
  ...
  function q(n) {
    return arguments.length || (n = ua.ascending), function (t, e) {
  ...
  function dt() {
    for (var n = null, t = Ja, e = 1 / 0; t;) {
      t.flush ? (delete $a[t.callback.id], t = n ? n.next = t.next : Ja = t.next) : (e = Math.min(e, t.then + t.delay), t = (n = t).next);
    }
  ...
  function Yt(n, t) {
    ...
    for (var e, r, i, u = 0, a = 0, o = n[0], c = o[0], l = o[1], f = Math.cos(l), s = Math.atan2(t * Math.sin(c) * f, Math.sin(l)), h = 1 - t * Math.cos(c) * f, g = s; ++u < e;) {
      o = n[u], f = Math.cos(l = o[1]), r = Math.atan2(t * Math.sin(c = o[0]) * f, Math.sin(l)), i = 1 - t * Math.cos(c) * f, Math.abs(h - 2) < ja && Math.abs(i - 2) < ja || (Math.abs(i) < ja || Math.abs(h) < ja || (Math.abs(Math.abs(r - s) - Da) < ja ? i + h > 2 && (a += 4 * (r - s)) : a += Math.abs(h - 2) < ja ? 4 * (r - g) : ((3 * Da + r - s) % (2 * Da) - Da) * (h + i)), g = s, s = r, h = i);
    }
  ...
  function Xt(n, t, e, r) {
    var i;
    if (null == n) i = e * Da / 2, r.point(-Da, i), r.point(0, i), r.point(Da, i), r.point(Da, 0), r.point(Da, -i), r.point(0, -i), r.point(-Da, -i), r.point(-Da, 0), r.point(-Da, i);else if (Math.abs(n[0] - t[0]) > ja) {
    ...
    function e(n) {
      ...
      return {
        ...
        point: function point(s, h) {
          ...
          if (!e && (l = c = d) && n.lineStart(), d !== c && (g = r(e, p), (Tt(e, g) || Tt(p, g)) && (p[0] += ja, p[1] += ja, d = t(p[0], p[1]))), d !== c) f = 0, d ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) : (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g;else if (o && e && a ^ d) {
            var v;
    ...
    return function (c) {
      ...
      function f(n) {
        for (var t = 0, e = M.length, r = n[1], i = 0; e > i; ++i) {
          for (var u = 1, a = M[i], o = a.length, c = a[0]; o > u; ++u) {
            b = a[u], c[1] <= r ? b[1] > r && s(c, b, n) > 0 && ++t : b[1] <= r && s(c, b, n) < 0 && --t, c = b;
          }
        }
      ...
      function v(n, t) {
        ...
        var e = g(n, t);
        if (M && x.push([n, t]), N) _ = n, w = t, S = e, N = !1, e && (c.lineStart(), c.point(n, t));else if (e && A) c.point(n, t);else {
          var r = [E, k],
              i = [n, t];
  ...
  function Wt(n) {
    ...
    }, ua.rebind(t, l, "precision"), function () {
  ...
  function ue(n, t) {
    ...
    return function (i, u, a, o) {
      ...
      for (var c, l = a * t, f = i; a > 0 ? f > u : u > f; f -= l) {
        o.point((c = qt([e, -r * Math.cos(f), -r * Math.sin(f)]))[0], c[1]);
      }
    };
  }
  ...
  function Ce(n) {
    function t(t) {
      ...
      for (var c, l = [], f = [], s = -1, h = t.length, g = ft(e), p = ft(r); ++s < h;) {
        i.call(this, c = t[s], s) ? f.push([+g.call(this, c, s), +p.call(this, c, s)]) : f.length && (a(), f = []);
      }
  ...
  function Ve(n) {
    ...
    for (e.push(Be(Po, u) + "," + Be(Po, a)), --r; ++r < i;) {
      t = n[r], u.shift(), u.push(t[0]), a.shift(), a.push(t[1]), $e(e, u, a);
    }
  ...
  function Xe(n) {
    ...
    for (t = [Be(Po, a), ",", Be(Po, o)], --r; ++r < u;) {
      e = n[r % i], a.shift(), a.push(e[0]), o.shift(), o.push(e[1]), $e(t, a, o);
    }
  ...
  function Ze(n, t) {
    var e = n.length - 1;
    if (e) for (var r, i, u = n[0][0], a = n[0][1], o = n[e][0] - u, c = n[e][1] - a, l = -1; ++l <= e;) {
  ...
  function Ge(n) {
    for (var t = 0, e = n.length - 1, r = [], i = n[0], u = n[1], a = r[0] = Je(i, u); ++t < e;) {
      r[t] = (a + (a = Je(i = u, u = n[t + 1]))) / 2;
    }
  ...
  function Ke(n) {
    for (var t, e, r, i, u = [], a = Ge(n), o = -1, c = n.length - 1; ++o < c;) {
      t = Je(n[o], n[o + 1]), Math.abs(t) < 1e-6 ? a[o] = a[o + 1] = 0 : (e = a[o] / t, r = a[o + 1] / t, i = e * e + r * r, i > 9 && (i = 3 * t / Math.sqrt(i), a[o] = i * e, a[o + 1] = i * r));
    }
  ...
  function gr(n, t) {
    ...
    return o[0] != c[0] || o[1] != c[1] ? (r.push("translate(", null, ",", null, ")"), i.push({
      ...
      i: e - 2,
      x: hr(g[1], p[1])
    })) : (p[0] != 1 || p[1] != 1) && r.push(r.pop() + "scale(" + p + ")"), e = i.length, function (n) {
      for (var t, u = -1; ++u < e;) {
        r[(t = i[u]).i] = t.x(n);
      }
  ...
  function pr(n, t) {
    ...
    for (e in n) {
      e in t ? r[e] = vr(e)(n[e], t[e]) : i[e] = n[e];
    }
  ...
  function dr(n, t) {
    ...
    for (n += "", t += "", Yo.lastIndex = 0, r = 0; e = Yo.exec(t); ++r) {
      e.index && l.push(t.substring(o, c = e.index)), f.push({
        i: l.length,
        x: e[0]
      }), l.push(null), o = Yo.lastIndex;
    }

    for (o < t.length && l.push(t.substring(o)), r = 0, u = f.length; (e = Yo.exec(n)) && u > r; ++r) {
      if (a = f[r], a.x == e[0]) {
        if (a.i) {
          if (l[a.i + 1] == null) for (l[a.i - 1] += a.x, l.splice(a.i, 1), i = r + 1; u > i; ++i) {
            f[i].i--;
          } else for (l[a.i - 1] += a.x + l[a.i + 1], l.splice(a.i, 2), i = r + 1; u > i; ++i) {
            f[i].i -= 2;
          }
        } else if (l[a.i + 1] == null) l[a.i] = a.x;else for (l[a.i] = a.x + l[a.i + 1], l.splice(a.i + 1, 1), i = r + 1; u > i; ++i) {
          f[i].i--;
        }
        f.splice(r, 1), u--, r--;
    ...
    for (; u > r;) {
      a = f.pop(), l[a.i + 1] == null ? l[a.i] = a.x : (l[a.i] = a.x + l[a.i + 1], l.splice(a.i + 1, 1)), u--;
    }
  ...
  function qr(n, t) {
    var e;
    return arguments.length < 2 && (t = .45), arguments.length ? e = t / (2 * Da) * Math.asin(1 / n) : (n = 1, e = t / 4), function (r) {
  ...
  function Pr(n) {
    for (var t = n.source, e = n.target, r = Or(t, e), i = [t]; t !== r;) {
      t = t.parent, i.push(t);
    }
  ...
  function Or(n, t) {
    ...
    for (var e = Rr(n), r = Rr(t), i = e.pop(), u = r.pop(), a = null; i === u;) {
      a = i, i = e.pop(), u = r.pop();
    }
  ...
  function Xr(n, t, e) {
    var r = 0,
        i = 0;
    if (n.charge = 0, !n.leaf) for (var u, a = n.nodes, o = a.length, c = -1; ++c < o;) {
      u = a[c], null != u && (Xr(u, t, e), n.charge += u.charge, r += u.charge * u.cx, i += u.charge * u.cy);
    }
  ...
  function si(n, t) {
    var e = n.children;
    if (e && (i = e.length)) for (var r, i, u = -1; ++u < i;) {
      t(r = si(e[u], t), n) > 0 && (n = r);
    }
    return n;
  }
  ...
  function di(n, t) {
    function e(n, r) {
      var i = n.children;
      if (i && (a = i.length)) for (var u, a, o = null, c = -1; ++c < a;) {
        u = i[c], e(u, o), o = u;
      }
      t(n, r);
    }
  ...
  function wi(n) {
    ...
    if ((e = n.children) && (l = e.length)) {
      var e,
          ...
          h = 1 / 0,
          g = -1 / 0;
      if (e.forEach(Si), r = e[0], r.x = -r.r, r.y = 0, t(r), l > 1 && (i = e[1], i.x = i.r, i.y = 0, t(i), l > 2)) for (u = e[2], Ai(r, i, u), t(u), xi(r, u), r._pack_prev = u, xi(u, i), i = r._pack_next, a = 3; l > a; a++) {
        Ai(r, i, u = e[a]);
        var p = 0,
            d = 1,
            m = 1;
        ...
        if (1 == p) for (c = r._pack_prev; c !== o._pack_prev && !_i(c, u); c = c._pack_prev, m++) {
          ;
        }
  ...
  function ki(n, t, e, r) {
    var i = n.children;
    if (n.x = t += r * n.x, n.y = e += r * n.y, n.r *= r, i) for (var u = -1, a = i.length; ++u < a;) {
      ki(i[u], t, e, r);
    }
  }
    ...
    return u.invert = function (t) {
      ...
      if (i.every(isFinite)) {
        var a = Math.log(t),
            ...
            f = r(i[1]),
            s = t % 1 ? 2 : t;
        if (e === $i) for (u.push(-Math.pow(t, -o)); o++ < c;) {
          for (var h = s - 1; h > 0; h--) {
  ...
  function ou(n) {
    for (var t, e, r, i = -1, u = n.length; ++i < u;) {
      t = n[i], e = t[0], r = t[1] + tc, t[0] = e * Math.cos(r), t[1] = e * Math.sin(r);
    }
  ...
  ua.ascending = function (n, t) {
    ...
    if (arguments.length === 1) {
      ...
      for (; ++i < u && ((e = t.call(n, n[i], i)) == null || e != e);) {
        e = void 0;
      }

      for (; ++i < u;) {
        (r = t.call(n, n[i], i)) != null && e > r && (e = r);
      }
    }
    ...
    if (arguments.length === 1) {
      for (; ++u < a && ((e = i = n[u]) == null || e != e);) {
        e = i = void 0;
      }

      for (; ++u < a;) {
        (r = n[u]) != null && (e > r && (e = r), r > i && (i = r));
      }
    } else {
      for (; ++u < a && ((e = i = t.call(n, n[u], u)) == null || e != e);) {
        e = void 0;
      }

      for (; ++u < a;) {
        (r = t.call(n, n[u], u)) != null && (e > r && (e = r), r > i && (i = r));
      }
    }
  ...
  ua.bisectLeft = sa.left, ua.bisect = ua.bisectRight = sa.right, ua.shuffle = function (n) {
    ...
    for (var n = -1, e = ua.min(arguments, t), r = Array(e); ++n < e;) {
      for (var i, u = -1, a = r[n] = Array(i); ++u < i;) {
        a[u] = arguments[u][n];
      }
    }
    ...
    var i,
        ...
        a = e(Math.abs(r)),
        o = -1;
    if (n *= a, t *= a, r *= a, 0 > r) for (; (i = n + r * ++o) > t;) {
      u.push(i / a);
    } else for (; (i = n + r * ++o) < t;) {
      u.push(i / a);
    }
  ...
  ua.nest = function () {
    function n(t, o, c) {
      ...
      for (var l, f, s, h, g = -1, p = o.length, d = a[c++], m = new i(); ++g < p;) {
  ...
  "function" == typeof Sizzle && (ya = function ya(n, t) {
  ...
  wa.select = function (n) {
    ...
    for (var a = -1, o = this.length; ++a < o;) {
      ...
      for (var c = -1, l = r.length; ++c < l;) {
        (i = r[c]) ? (t.push(e = n.call(i, i.__data__, c)), e && "__data__" in i && (e.__data__ = i.__data__)) : t.push(null);
      }
    }
    ...
    for (var i = -1, u = this.length; ++i < u;) {
      for (var a = this[i], o = -1, c = a.length; ++o < c;) {
        (e = a[o]) && (r.push(t = da(n.call(e, e.__data__, o))), t.parentNode = e);
      }
    }
  ...
  ua.selection.enter = L, ua.selection.enter.prototype = Aa, Aa.append = wa.append, Aa.insert = wa.insert, Aa.empty = wa.empty, Aa.node = wa.node, Aa.select = function (n) {
    for (var t, e, r, i, u, a = [], o = -1, c = this.length; ++o < c;) {
      ...
      for (var l = -1, f = i.length; ++l < f;) {
        (u = i[l]) ? (t.push(r[l] = e = n.call(i.parentNode, u.__data__, l)), e.__data__ = u.__data__) : t.push(null);
      }
    }
  ...
  var qa,
      Ta = [0, 1 / 0],
      Ca = "onwheel" in aa ? (qa = function qa() {
    return -ua.event.deltaY * (ua.event.deltaMode ? 120 : 1);
  }, "wheel") : "onmousewheel" in aa ? (qa = function qa() {
    return ua.event.wheelDelta;
  }, "mousewheel") : (qa = function qa() {
  ...
  Va.forEach(function (n, t) {
    ...
    return "onload" in c ? c.onload = c.onerror = r : c.onreadystatechange = function () {
      ...
      if (arguments.length === 2 && "function" == typeof r && (u = r, r = null), c.open(e, n, !0), null == t || "accept" in a || (a.accept = t + ",*/*"), c.setRequestHeader) for (var o in a) {
  ...
  var Ga = oa.requestAnimationFrame || oa.webkitRequestAnimationFrame || oa.mozRequestAnimationFrame || oa.oRequestAnimationFrame || oa.msRequestAnimationFrame || function (n) {
    setTimeout(n, 17);
      ...
      Wa = ",",
      Qa = [3, 3],
      no = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(mt);
  ...
  if (Qa) {
    ...
    ro = function ro(n) {
      for (var t = n.lastIndexOf("."), e = t >= 0 ? "." + n.substring(t + 1) : (t = n.length, ""), r = [], i = 0, u = Qa[0]; t > 0 && u > 0;) {
        r.push(n.substring(t -= u, t + u)), u = Qa[i = (i + 1) % io];
      }
  ...
  ua.geo.bounds = function () {
    ...
    return function (n) {
      ...
      for (var t, e = 1, r = M.length, i = M[0], u = [i]; r > e; ++e) {
        t = M[e], l(t[0], i) || l(t[1], i) ? (o(i[0], t[1]) > o(i[0], i[1]) && (i[1] = t[1]), o(t[0], i[1]) > o(i[0], i[1]) && (i[0] = t[0])) : u.push(i = t);
      }

      for (var a, t, p = -1 / 0, r = u.length - 1, e = 0, i = u[r]; r >= e; i = t, ++e) {
        t = u[e], (a = o(i[1], t[0])) > p && (p = a, f = t[0], h = i[1]);
      }

      return M = x = null, [[f, s], [h, g]];
    };
  ...
  (ua.geo.conicEqualArea = function () {
    ...
    return n.invert = function (n) {
      ...
      var l = u.scale(),
          f = +t[0],
          s = +t[1];
      return e = u.translate(t).clipExtent([[f - .455 * l, s - .238 * l], [f + .455 * l, s + .238 * l]]).stream(c).point, r = a.translate([f - .307 * l, s + .201 * l]).clipExtent([[f - .425 * l + ja, s + .12 * l + ja], [f - .214 * l - ja, s + .234 * l - ja]]).stream(c).point, i = o.translate([f - .205 * l, s + .212 * l]).clipExtent([[f - .214 * l + ja, s + .166 * l + ja], [f - .115 * l - ja, s + .234 * l - ja]]).stream(c).point, n;
    }, n.scale(1070);
  };
  ...
  ua.geo.path = function () {
    ...
    return n.area = function (n) {
      ...
      return Eo = ko = -(wo = So = 1 / 0), ua.geo.stream(n, r(No)), [[wo, So], [Eo, ko]];
  ...
  ua.geom.hull = function (n) {
    function t(n) {
      ...
      var t,
          ...
          x = [],
          b = 0;
      if (d === ze && r === De) t = n;else for (u = 0, t = []; v > u; ++u) {
        t.push([+d.call(this, i = n[u], u), +m.call(this, i, u)]);
      }

      for (u = 1; v > u; ++u) {
        (t[u][1] < t[b][1] || t[u][1] == t[b][1] && t[u][0] < t[b][0]) && (b = u);
      }
    ...
    return n.area = function () {
      ...
      for (arguments.length || (t = -1 / (6 * n.area())); ++i < u;) {
        e = c, c = n[i], r = e[0] * c[1] - c[0] * e[1], a += (e[0] + c[0]) * r, o += (e[1] + c[1]) * r;
      }

      return [a * t, o * t];
    }, n.clip = function (t) {
      for (var e, r, i, u, a, o, c = -1, l = n.length, f = n[l - 1]; ++c < l;) {
        for (e = t.slice(), t.length = 0, u = n[c], a = e[(i = e.length) - 1], r = -1; ++r < i;) {
          o = e[r], nr(o, f, u) ? (nr(a, f, u) || t.push(tr(a, o, f, u)), t.push(o)) : nr(a, f, u) && t.push(tr(a, o, f, u)), a = o;
        }
    ...
    function t(n) {
      var t,
        ...
        return [];
          ...
          f = n.length,
          s = 1e6;
      if (c === ze && l === De) t = n;else for (t = [], a = 0; f > a; ++a) {
    ...
    return arguments.length ? t(n) : (t.x = function (n) {
      ...
      return arguments.length ? (null == n ? e = null : (r = [+n[0], +n[1]], e = ua.geom.polygon([[0, 0], [0, r[1]], r, [r[0], 0]]).clip), t) : r;
    }, t.links = function (n) {
      var t,
          e,
          r,
        ...
        return [];
          ...
          l = ft(u),
          f = n.length;
      if (c === ze && l === De) t = n;else for (r = 0; f > r; ++r) {
  ...
  ua.geom.quadtree = function (n, t, e, r, i) {
    function u(n) {
      function u(n, t, e, r, i, u, a, o) {
        if (!isNaN(e) && !isNaN(r)) if (n.leaf) {
          var c = n.x,
              f = n.y;
          if (null != c) {
            if (Math.abs(c - e) + Math.abs(f - r) < .01) l(n, t, e, r, i, u, a, o);else {
              var s = n.point;
      ...
      var f,
          ...
          M = ft(o),
          x = ft(c);
      if (null != t) d = t, m = e, v = r, y = i;else if (v = y = -(d = m = 1 / 0), s = [], h = [], p = n.length, a) for (g = 0; p > g; ++g) {
  ...
  ua.ease = function (n) {
    ...
    return o.tick = function () {
      ...
      for (e = 0; _ > e; ++e) {
        o = v[e], s = o.source, h = o.target, M = h.x - s.x, x = h.y - s.y, (d = M * M + x * x) && (d = r * u[e] * ((d = Math.sqrt(d)) - i[e]) / d, M *= d, x *= d, h.x -= M * (y = s.weight / (h.weight + s.weight)), h.y -= x * y, s.x += M * (y = 1 - y), s.y += x * y);
      }

      if ((y = r * p) && (M = l[0] / 2, x = l[1] / 2, e = -1, y)) for (; ++e < b;) {
        o = m[e], o.x += (M - o.x) * y, o.y += (x - o.y) * y;
      }
      if (g) for (Xr(t = ua.geom.quadtree(m), r, a), e = -1; ++e < b;) {
      ...
      if (i = [], "function" == typeof s) for (e = 0; d > e; ++e) {
        i[e] = +s.call(this, v[e], e);
      } else for (e = 0; d > e; ++e) {
        i[e] = s;
      }
      if (u = [], "function" == typeof h) for (e = 0; d > e; ++e) {
  ...
  ua.layout.hierarchy = function () {
    ...
    function t(n, r) {
      var i = n.children,
          a = 0;
      if (i && (o = i.length)) for (var o, c = -1, l = r + 1; ++c < o;) {
        a += t(i[c], l);
  ...
  var $o = ua.map({
    "inside-out": function insideOut(n) {
      ...
      for (t = 0; r > t; ++t) {
        e = a[t], c > o ? (o += u[e], l.push(e)) : (c += u[e], f.push(e));
      }
  ...
  ua.layout.histogram = function () {
    function n(n, u) {
      for (var a, o, c = [], l = n.map(e, this), f = r.call(this, l, u), s = i.call(this, f, l, u), u = -1, h = l.length, g = s.length - 1, p = t ? 1 : 1 / h; ++u < g;) {
        a = c[u] = [], a.dx = s[u + 1] - (a.x = s[u]), a.y = 0;
      }

      if (g > 0) for (u = -1; ++u < h;) {
        o = l[u], o >= f[0] && o <= f[1] && (a = c[ua.bisect(s, o, 1, g) - 1], a.y += p, a.push(n[u]));
      }
      return c;
    }
    ...
    function n(n, i) {
      ...
      function o(n, t, r) {
        if (t) {
          for (var i, u = n, a = n, o = t, c = n.parent.children[0], l = u._tree.mod, f = a._tree.mod, s = o._tree.mod, h = c._tree.mod; o = fi(o), u = li(u), o && u;) {
            c = li(c), a = fi(a), a._tree.ancestor = n, i = o._tree.prelim + s - u._tree.prelim - l + e(o, u), i > 0 && (vi(yi(o, n, r), n, i), l += i, f += i), s += o._tree.mod, l += u._tree.mod, h += c._tree.mod, f += a._tree.mod;
          }
    ...
    function t(e) {
      ...
      if (u && u.length) {
        ...
        for (n(h, l.dx * l.dy / e.value), f.area = 0; (c = h.length) > 0;) {
          f.push(a = h[c - 1]), f.area += a.area, "squarify" !== g || (o = r(f, d)) <= p ? (h.pop(), p = o) : (f.area -= f.pop().area, i(f, d, l, !1), d = Math.min(l.dx, l.dy), f.length = f.area = 0, p = 1 / 0);
        }
    ...
    function e(t) {
      ...
      if (r && r.length) {
        ...
        for (n(o, a.dx * a.dy / t.value), c.area = 0; u = o.pop();) {
          c.push(u), c.area += u.area, u.z != null && (i(c, u.z ? a.dx : a.dy, a, !o.length), c.length = c.area = 0);
        }
    ...
    function r(n, t) {
      for (var e, r = n.area, i = 0, u = 1 / 0, a = -1, o = n.length; ++a < o;) {
    ...
    function i(n, t, e, r) {
      ...
      if (t == e.dx) {
        for ((r || f > e.dy) && (f = e.dy); ++u < a;) {
          i = n[u], i.x = o, i.y = l, i.dy = f, o += i.dx = Math.min(e.x + e.dx - o, f ? c(i.area / f) : 0);
        }

        i.z = !0, i.dx += e.x + e.dx - o, e.y += f, e.dy -= f;
      } else {
        for ((r || f > e.dx) && (f = e.dx); ++u < a;) {
          i = n[u], i.x = o, i.y = l, i.dx = f, l += i.dy = Math.min(e.y + e.dy - l, f ? c(i.area / f) : 0);
        }
    ...
    return u.size = function (n) {
      ...
      var r;
      return s = (f = n) == null ? zi : (r = _typeof(n)) == "function" ? t : "number" === r ? (n = [n, n, n, n], e) : e, u;
    }, u.round = function (n) {
  ...
  oc.call = wa.call, oc.empty = wa.empty, oc.node = wa.node, ua.transition = function (n) {
    ...
    for (var a = -1, o = this.length; ++a < o;) {
      ...
      for (var c = this[a], l = -1, f = c.length; ++l < f;) {
        (r = c[l]) && (e = n.call(r, r.__data__, l)) ? ("__data__" in r && (e.__data__ = r.__data__), yu(e, l, i, r.__transition__[i]), t.push(e)) : t.push(null);
      }
    }
    ...
    function i(t) {
      return null == t ? r : (t += "", function () {
        var r,
            i = oa.getComputedStyle(this, null).getPropertyValue(n);
    ...
    for (var n, t, e, r, i = this.id, u = ++cc, a = [], o = 0, c = this.length; c > o; o++) {
      ...
      for (var t = this[o], l = 0, f = t.length; f > l; l++) {
        (e = t[l]) && (r = Object.create(e.__transition__[i]), r.delay += r.duration, yu(e, l, u, r)), n.push(e);
      }
    }
  ...
  ua.svg.brush = function () {
    ...
    function i() {
      ...
      if (E) k[0] = s[0][0] - k[0], k[1] = s[0][1] - k[1];else if (_) {
        var N = +/w$/.test(_),
            q = +/^n/.test(_);
  ...
  var hc = {
    ...
    sw: "nesw-resize"
      ...
      gc = [["n", "e", "s", "w", "nw", "ne", "se", "sw"], ["e", "w"], ["n", "s"], []];
  ua.time = {};
  var pc = Date,
  ...
  ua.time.year = wu(function (n) {
    ...
    function t(t) {
      for (var r, i, u, a = [], o = -1, c = 0; ++o < e;) {
        n.charCodeAt(o) === 37 && (a.push(n.substring(c, o)), (i = Tc[r = n.charAt(++o)]) != null && (r = n.charAt(++o)), (u = Cc[r]) && (r = u(t, null == i ? "e" === r ? " " : "0" : i)), a.push(r), c = o + 1);
      }
  ...
  var Fc = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6],
      Hc = [[ua.time.second, 1], [ua.time.second, 5], [ua.time.second, 15], [ua.time.second, 30], [ua.time.minute, 1], [ua.time.minute, 5], [ua.time.minute, 15], [ua.time.minute, 30], [ua.time.hour, 1], [ua.time.hour, 3], [ua.time.hour, 6], [ua.time.hour, 12], [ua.time.day, 1], [ua.time.day, 2], [ua.time.week, 1], [ua.time.month, 1], [ua.time.month, 3], [ua.time.year, 1]],
      Pc = [[ua.time.format("%Y"), Lt], [ua.time.format("%B"), function (n) {
    return n.getMonth();
  ...
  var Yc = Hc.map(function (n) {
    return [n[0].utc, n[1]];
      ...
      Uc = [[ua.time.format.utc("%Y"), Lt], [ua.time.format.utc("%B"), function (n) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/d3.v3.min.js"], null)
//# sourceMappingURL=/d3.v3.min.de62a014.js.map